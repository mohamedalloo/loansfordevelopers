/* LoansForDevelopers match form — AdaptLend engine. One big friendly question per screen. */
...
const SITE = {
  "key": "loansfordevelopers",
  "brand": "LoansForDevelopers",
  "questions": [
    {
      "id": "goal",
      "question": "What brings you here today?",
      "hint": "Exits, cash-out, and acquisition lines are our specialty \u2014 LLCs welcome.",
      "options": [
        {
          "value": "cashout",
          "icon": "banknote",
  ...
  "reviews": [
    {
      "quote": "The DSCR refi was locked before my bridge loan hit month six. Paid off the hard money at month seven, rate I could live with forever.",
      "who": "Victor N.",
      "meta": "BRRRR exit refi \u00b7 Indianapolis, IN"
    },
    {
      "quote": "My HELOC has written the earnest check on my last four deals. By the time competitors get proof of funds, I'm in contract.",
      "who": "Sasha K.",
